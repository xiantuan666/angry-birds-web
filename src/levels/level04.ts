...
export const level04: LevelConfig = {
  ...
  targets: [
    ...
    { type: 'pig4', x: 975, y: 642 },
    { type: 'king', x: 975, y: 545 },
    { type: 'helmet', x: 1450, y: 602 },
  ...
  blocks: [
    ...
    { material: 'wood', x: 975, y: 676, width: 220, height: 24 },
    { material: 'wood', x: 930, y: 629, width: 26, height: 70 },
    { material: 'wood', x: 1020, y: 629, width: 26, height: 70 },
    { material: 'wood', x: 975, y: 580, width: 140, height: 22 },
    // 石基掩体：石柱 + 石梁
    { material: 'stone', x: 1400, y: GY - 75, width: 30, height: 150 },
    { material: 'stone', x: 1500, y: GY - 75, width: 30, height: 150 },
    { material: 'stone', x: 1450, y: 638, width: 160, height: 26 },
    // 空地：玻璃掩体 + 木块
