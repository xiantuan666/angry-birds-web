...
export const level05: LevelConfig = {
  ...
  targets: [
    ...
    { type: 'helmet', x: 1450, y: 641 },
    { type: 'king', x: 1250, y: 749 },
  ...
  blocks: [
    ...
    { material: 'wood', x: 1450, y: 676, width: 140, height: 24 },
    // 玻璃碉堡（木框架）：藏猪王
    ...
    { material: 'wood', x: 1250, y: 715, width: 130, height: 12 },
    // 空地玻璃护盾
