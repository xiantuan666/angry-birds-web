...
export const level06: LevelConfig = {
  ...
  targets: [
    ...
    { type: 'pig4', x: 900, y: 603 },
    { type: 'helmet', x: 1250, y: GY - 22 },
    { type: 'pig5', x: 1250, y: 642 },
    { type: 'king', x: 1550, y: 749 },
  ...
  blocks: [
    ...
    { material: 'wood', x: 1550, y: 715, width: 130, height: 12 },
    // 装饰与空地
